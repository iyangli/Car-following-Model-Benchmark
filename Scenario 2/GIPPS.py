...
path="C:\\Users\\cc_01\\Desktop\\基准分析\\数值仿真\\数值仿真\\场景2，跟驰，被抢道，跟驰，两辆车\\输出文件\\统计分析,version-8\\GIPPS-cut_in=10.xlsx"
...
while time <=forehead_total_time:
    ...
    cur_spe_2 = pre_spe_list[0] + 2.5 * Max_Acc * Reaction_Time * (1 - pre_spe_list[0] / Desire_Spe) * math.sqrt(
        0.025 + pre_spe_list[0] / Desire_Spe)
    ...
    cur_acc = (cur_spe - last_spe) / time_interval

...
while True:
    ...
    V_desire=min(Max_Spe,cur_spe+Max_Acc*0.1,V_safe)
    cur_spe=max(0,V_desire-0)

    cur_acc=(cur_spe-last_spe)/0.1
...
data.to_excel("C:\\Users\\cc\\Desktop\\代码\\分场景检验\\场景1，启动，加速，自由流，停车\\输出文件\\Krauss.xlsx")
